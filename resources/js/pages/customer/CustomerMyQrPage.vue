...
<template>
  <AppShell>
    ...
    >
      ...
      <template v-else>
        <AppCard wrapper-class="w-full rounded-3xl border border-slate-200 bg-white/95 p-6 shadow-[0_20px_50px_-24px_rgba(15,23,42,0.16)]">
          <div class="grid place-items-center rounded-2xl bg-slate-50 p-5">
            <div class="w-fit rounded-2xl bg-white p-3 ring-1 ring-slate-200 [&_canvas]:block">
              <QrcodeVue
                :value="qrValue"
                :size="220"
                level="M"

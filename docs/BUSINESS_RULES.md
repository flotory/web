...
- Owner **Rewards** page shows the same 5-column stamp grid guests see; owners **click** a reward card to select it and use **Edit** / **Archive** in the toolbar below the grid (not a separate card list or hover menu).

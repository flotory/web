...
use App\Http\Controllers\Api\AdminVenueRewardController;
...
Route::middleware('auth:sanctum')->group(function (): void {
    ...
    Route::middleware('admin')->prefix('admin')->group(function (): void {
        ...
        Route::post('/manage-venues/{venue}/setup-files', [AdminVenueSetupFileController::class, 'store']);
        Route::delete('/manage-venues/{venue}/setup-files/{setupFile}', [AdminVenueSetupFileController::class, 'destroy']);
        Route::get('/manage-venues/{venue}/rewards', [AdminVenueRewardController::class, 'index']);
        Route::post('/manage-venues/{venue}/rewards', [AdminVenueRewardController::class, 'store']);
        Route::put('/manage-venues/{venue}/rewards/{reward}', [AdminVenueRewardController::class, 'update']);
        Route::patch('/manage-venues/{venue}/rewards/{reward}/archive', [AdminVenueRewardController::class, 'archive']);
        Route::patch('/manage-venues/{venue}/rewards/{reward}/reactivate', [AdminVenueRewardController::class, 'reactivate']);
        Route::delete('/manage-venues/{venue}/rewards/{reward}/purge', [AdminVenueRewardController::class, 'purge']);
